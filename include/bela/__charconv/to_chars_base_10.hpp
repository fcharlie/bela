...
template <class _Tp> constexpr wchar_t *__append1(wchar_t *__buffer, _Tp __value) noexcept {
  *__buffer = L'0' + static_cast<wchar_t>(__value);
  return __buffer + 1;
}

template <class _Tp> constexpr wchar_t *__append2(wchar_t *__buffer, _Tp __value) noexcept {
  std::memcpy(__buffer, &__digits_base_10<>::__value[(__value)*2], 2 * sizeof(wchar_t));
  return __buffer + 2;
}

template <class _Tp> constexpr wchar_t *__append3(wchar_t *__buffer, _Tp __value) noexcept {
  return __itoa::__append2(__itoa::__append1(__buffer, (__value) / 100), (__value) % 100);
}

template <class _Tp> constexpr wchar_t *__append4(wchar_t *__buffer, _Tp __value) noexcept {
  return __itoa::__append2(__itoa::__append2(__buffer, (__value) / 100), (__value) % 100);
}

template <class _Tp> constexpr wchar_t *__append2_no_zeros(wchar_t *__buffer, _Tp __value) noexcept {
  if (__value < 10)
...
template <class _Tp> constexpr wchar_t *__append4_no_zeros(wchar_t *__buffer, _Tp __value) noexcept {
  if (__value < 100)
...
template <class _Tp> constexpr wchar_t *__append8_no_zeros(wchar_t *__buffer, _Tp __value) noexcept {
  if (__value < 10000)
